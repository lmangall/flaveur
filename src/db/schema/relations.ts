...
export const variation_groupRelations = relations(
  variation_group,
  ({ one, many }) => ({
    user: one(users, {
...
export const workspace_inviteRelations = relations(
  workspace_invite,
  ({ one }) => ({
    workspace: one(workspace, {
...
export const flavour_invitesRelations = relations(
  flavour_invites,
  ({ one }) => ({
    flavour: one(flavour, {
...
export const workspace_documentRelations = relations(
  workspace_document,
  ({ one }) => ({
    workspace: one(workspace, {
...
export const user_learning_queueRelations = relations(
  user_learning_queue,
  ({ one }) => ({
    user: one(users, {
...
export const substance_learning_progressRelations = relations(
  substance_learning_progress,
  ({ one }) => ({
    user: one(users, {
...
export const learning_streakRelations = relations(
  learning_streak,
  ({ one }) => ({
    user: one(users, {
...
export const learning_reviewRelations = relations(
  learning_review,
  ({ one }) => ({
    user: one(users, {
...
export const learning_quiz_attemptRelations = relations(
  learning_quiz_attempt,
  ({ one }) => ({
    user: one(users, {
...
export const learning_sessionRelations = relations(
  learning_session,
  ({ one, many }) => ({
    user: one(users, {
...
export const substance_functional_groupRelations = relations(
...
export const functional_groupRelations = relations(
  functional_group,
  ({ many }) => ({
    substance_functional_groups: many(substance_functional_group),
  })
...
export const workspace_flavourRelations = relations(
  workspace_flavour,
  ({ one }) => ({
    workspace: one(workspace, {
...
export const learning_session_substanceRelations = relations(
  learning_session_substance,
  ({ one }) => ({
...
export const substance_flavourRelations = relations(
  substance_flavour,
  ({ one }) => ({
    flavour: one(flavour, {
...
export const ingredient_flavourRelations = relations(
  ingredient_flavour,
  ({ one }) => ({
