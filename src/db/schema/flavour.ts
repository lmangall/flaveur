...
export const flavour = pgTable(
  ...
  (table) => [
    index("idx_flavour_category_id")
      .using("btree", table.category_id.asc().nullsLast().op("int4_ops")),
    index("idx_flavour_is_public")
      .using("btree", table.is_public.asc().nullsLast().op("bool_ops")),
    index("idx_flavour_status")
      .using("btree", table.status.asc().nullsLast().op("text_ops")),
    index("idx_flavour_user_id")
