    ...
    <div className="relative flex min-h-screen items-center justify-center p-4 overflow-hidden">
      ...
      <Card className="w-full max-w-md border-pink-200/50 dark:border-pink-500/20 shadow-lg shadow-pink-100/50 dark:shadow-pink-900/20">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold bg-gradient-to-r from-pink-600 to-pink-500 dark:from-pink-400 dark:to-pink-300 bg-clip-text text-transparent">Create an account</CardTitle>
          <CardDescription>
